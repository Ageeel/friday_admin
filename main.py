...
# Import the helper function from your custom file
...
class SubscriptionApp:
    ...
    def render_data(self, data, query=""):
        ...
        # Fixed calculation logic: total_deposits removed completely from total balance
