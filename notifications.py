...
class NotificationCard(ft.Container):
    ...
    def __init__(self, text, amount, notif_type, date, img_url, notif_key, page: ft.Page, refresh_callback):
        super().__init__()
        self.text = text
        self.amount = amount
    ...
    def edit_notification(self, e):
        ...
        show_img = self.notif_type in ["n", "don"]
        ...
        dialog = ft.AlertDialog(
            ...
            content=ft.Column(controls=[desc_input, amount_input, img_input], tight=True, spacing=15),
            actions=[
    ...
    def build_card_ui(self):
        ...
        # Add "اشعار بنكك" button compatible with Flet 0.19.0
        if self.img_url and self.img_url.strip():
            column_controls.append(
                ft.TextButton(
                    content=ft.Row(
                        controls=[
                            ft.Icon(ft.icons.CHECK_CIRCLE, color=ft.colors.LIME_600, size=16),
                            ft.Text("اشعار بنكك", color=ft.colors.LIME_600, size=12)
                        ],
                        tight=True,
                        spacing=4
                    ),
...
class AddNotificationDialog:
    ...
    def show(self):
        ...
        dialog = ft.AlertDialog(
            ...
            content=ft.Column(
                controls=[self.noti_type_dropdown, self.desc_input, self.amount_input, self.img_input],
                tight=True,
                spacing=15
            ),
            actions=[
